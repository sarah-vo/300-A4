...
void initialize_lists(){
    ...
    // Randomly choose how many integers will be generated
    ...
    // Create (total) number of non-repetitive integers
...
int main(){
    ...
    printf("\nLongest track delay for each algorithm compared to FCFS:\n");
    printf("  - SCAN: %d\n", longestDelay(list_scan));
    printf("  - CSCAN: %d\n", longestDelay(list_cscan));

    printf("\nAverage track delay for each algorithm compared to FCFS:\n");
